...
export default function Home(_: InferGetServerSidePropsType<typeof getServerSideProps>) {
	...
	return (
		<>
			<Head>
				<title>{t("tatis.title")}</title>
				<meta name="description" content={t("tatis.description")} />
			...
			<main className="flex min-h-screen flex-col items-center bg-black">
				...
				<div className="relative min-h-[80svh] mb-6 w-[100svw] overflow-x-auto lg:min-h-[80svh]">
					<p className="text-t-white mx-[10svw] md:mx-0 text-4xl md:text-5xl sticky left-2 justify-center lg:flex mb-4 font-semibold">
						{t("tatis.services.title")}
					</p>
				...
				<div className="relative min-h-[90svh] pb-10 w-[100svw] px-10 flex justify-center flex-col items-center overflow-x-auto lg:min-h-[80svh]">
					...
					<div className="flex flex-col gap-y-12 items-center">
						<ul className="p-5 ring-2 ring-t-white min-h-20 lg:w-4/6 flex flex-col gap-y-3">
							...
							<li className="md:text-lg font-body text-t-white">{t("tatis.benefits.motor_skills")}</li>
							<li className="md:text-lg font-body text-t-white">{t("tatis.benefits.teamwork")}</li>
